...
int gpio_bt_sys_rest_en = 107;	//BT reset pin
...
void __init msm7627a_bt_power_init(void)
{
	...
	//Cellon add and modify start, Eagle.Yin, 2012/12/27 for debug WCN2243 code
	//gpio_bt_config();
	...
	//Cellon add and modify end, Eagle.Yin, 2012/12/27 for debug WCN2243 code
